        ...
        <div class="confirm-table">
            <table class="confirm-table__inner">
                ...
                <tr class="confirm-table__row">
                    ...
                    <td class="confirm-table__text">
                        <input type="text" name="gender_content" value="{{ $gender_content }}" readonly disabled />
                ...
                <tr class="confirm-table__row">
                    ...
                    <td class="confirm-table__text">
                        <input type="text" name="category_content" value="{{ $category['content'] }}" readonly disabled />
