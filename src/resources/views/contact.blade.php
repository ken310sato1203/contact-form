        ...
        <div class="form__group">
            ...
            <div class="form__group-content">
                <div class="form__input--text-tel">
                    <input size="5" type="text" name="tel1" placeholder="080" value="{{ old('tel1') }}" /> - <input size=" 7" type="text" name="tel2" placeholder="1234" value="{{ old('tel2') }}" /> - <input size=" 7" type="text" name="tel3" placeholder="5678" value="{{ old('tel3') }}" />
                </div>
                <div class=" form__error">
